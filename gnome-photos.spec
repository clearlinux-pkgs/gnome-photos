...
Source0  : https://download.gnome.org/sources/gnome-photos/3.34/gnome-photos-3.34.2.tar.xz
...
%prep
%setup -q -n gnome-photos-3.34.2
cd %{_builddir}/gnome-photos-3.34.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590421275
...
cp %{_builddir}/gnome-photos-3.34.2/COPYING %{buildroot}/usr/share/package-licenses/gnome-photos/31a3d460bb3c7d98845187c716a30db81c44b615
