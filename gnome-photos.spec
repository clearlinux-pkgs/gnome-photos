...
%prep
%setup -q -n gnome-photos-40.0
cd %{_builddir}/gnome-photos-40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629135189
...
cp %{_builddir}/gnome-photos-40.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-photos/31a3d460bb3c7d98845187c716a30db81c44b615
