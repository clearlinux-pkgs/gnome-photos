...
Source0  : https://download.gnome.org/sources/gnome-photos/3.38/gnome-photos-3.38.0.tar.xz
...
%prep
%setup -q -n gnome-photos-3.38.0
cd %{_builddir}/gnome-photos-3.38.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1600892235
...
cp %{_builddir}/gnome-photos-3.38.0/COPYING %{buildroot}/usr/share/package-licenses/gnome-photos/31a3d460bb3c7d98845187c716a30db81c44b615
