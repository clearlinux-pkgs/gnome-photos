...
Source0  : https://download.gnome.org/sources/gnome-photos/3.26/gnome-photos-3.26.3.tar.xz
...
export LANG=C
export SOURCE_DATE_EPOCH=1518716008
...
%files data
%defattr(-,root,root,-)
/usr/share/appdata/org.gnome.Photos.appdata.xml
